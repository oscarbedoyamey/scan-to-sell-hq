...
const en = {
  ...
  hero: {
    ...
    titleHighlight: '24/7 lead machine',
    subtitle: 'Every Zigno sign includes a QR code that takes the buyer to a page with all the property details. You receive the contact info without answering a single message and without any hassle.',
    cta: 'Start free',
...
const fr = {
  ...
  hero: {
    ...
    titleHighlight: 'machine à leads 24h/24',
    subtitle: 'Chaque panneau Zigno inclut un QR code qui dirige l\'acheteur vers une page avec toutes les informations du bien. Vous recevez les coordonnées du contact, sans répondre à aucun message et sans aucune gêne.',
...
const es = {
  ...
  hero: {
    ...
    titleHighlight: 'máquina de leads 24/7',
    subtitle: 'Cada cartel Zigno incluye un QR que lleva al comprador a una página con toda la información del inmueble. Tú recibes la información del contacto, sin contestar ningún mensaje y sin molestias.',
    cta: 'Empieza gratis',
...
const de = {
  ...
  hero: {
    ...
    titleHighlight: '24/7-Lead-Maschine',
    subtitle: 'Jedes Zigno-Schild enthält einen QR-Code, der den Käufer zu einer Seite mit allen Immobiliendetails führt. Du erhältst die Kontaktdaten, ohne eine einzige Nachricht zu beantworten und ohne jede Störung.',
...
const it = {
  ...
  hero: {
    ...
    titleHighlight: 'macchina di lead 24/7',
    subtitle: 'Ogni cartello Zigno include un QR che porta l\'acquirente a una pagina con tutte le informazioni dell\'immobile. Tu ricevi i dati di contatto, senza rispondere a nessun messaggio e senza alcun disturbo.',
    cta: 'Inizia gratis',
...
const pt = {
  ...
  hero: {
    ...
    titleHighlight: 'máquina de leads 24/7',
    subtitle: 'Cada cartaz Zigno inclui um QR que leva o comprador a uma página com todas as informações do imóvel. Você recebe os dados de contacto, sem responder a nenhuma mensagem e sem qualquer incómodo.',
    cta: 'Comece grátis',
...
const pl = {
  ...
  hero: {
    ...
    titleHighlight: 'maszynę do leadów 24/7',
    subtitle: 'Każda tabliczka Zigno zawiera kod QR, który kieruje kupującego na stronę ze wszystkimi informacjami o nieruchomości. Otrzymujesz dane kontaktowe, nie odpowiadając na żadną wiadomość i bez żadnych kłopotów.',
