...
const en = {
  ...
  howItWorks: {
    ...
    step4: {
      ...
      description: 'Place your poster and let it work for you 24/7. Filter out irrelevant calls and focus only on genuinely interested people.',
...
const es = {
  ...
  howItWorks: {
    ...
    step4: {
      ...
      description: 'Pon tu cartel y deja que trabaje por ti las 24 horas. Filtra llamadas irrelevantes y céntrate solo en los interesados de verdad.',
