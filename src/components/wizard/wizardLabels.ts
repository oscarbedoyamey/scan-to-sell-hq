...
const wizardLabels: Record<string, Record<string, string>> = {
  ...
  whatsappNumber: { en: 'WhatsApp number (with country code)', es: 'Número de WhatsApp (con código de país)', fr: 'Numéro WhatsApp (avec indicatif)', de: 'WhatsApp-Nummer (mit Landesvorwahl)', it: 'Numero WhatsApp (con prefisso)', pt: 'Número WhatsApp (com código do país)', pl: 'Numer WhatsApp (z kodem kraju)' },
